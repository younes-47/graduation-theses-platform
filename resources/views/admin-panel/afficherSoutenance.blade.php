            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-7">
                    <div class="team-single-text padding-50px-left sm-no-padding-left">
                        <h4 class="font-size38 sm-font-size32 xs-font-size30">{{ $soutenance['nom_etudiant'] }}
                            {{ $soutenance['prenom_etudiant'] }}</h4>
                            ...
                            <ul class="list-style9 no-margin">
                                ...
                                <li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 col-7">
                                            @php
                                                $etudiant = \App\Models\Etudiant::where('num_etd', $soutenance['num_etd'])
                                                    ->get('*')
                                                    ->first();
                                            @endphp
                                ...
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 col-7">
                                            @php
                                                $encadrant = \App\Models\Jury::where('num_jury', $soutenance['encadrant'])
                                                    ->get('*')
                                                    ->first();
                                            @endphp
